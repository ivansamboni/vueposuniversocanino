<template>
    <v-alert text="Cree marcas y asocielas a productos" title="Creación de Marcas" type="primary"
                            ...
                            <v-row>
                                <v-col cols="12" md="6">
                                    <v-text-field v-model="txtregdata.nombre" :rules="nombreRules" required
                                        hide-details="auto" variant="underlined" color="primary" label="Nombre de Marca"
            ...
            <tbody>
                <tr v-for="mac in marcasList.data" :key="mac.id">
                    ...
                    <td>
                        ...
                        <v-btn color="dark" @click="deleteMarca(mac.id)" density="comfortable"
