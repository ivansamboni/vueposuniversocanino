        ...
        <v-row justify="center">
          <v-col cols="12" md="9">
            <v-card elevation="12" class="pa-6">
              <v-form @submit.prevent="update()" class="loginForm">
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field v-model="txtregdata.numidentificacion" :rules="nombreRules" required
                      hide-details="auto" variant="underlined" color="info" label="Número de Identificación" />
                    <v-text-field v-show="numnit" v-model="txtregdata.numidentificacion" :rules="nombreRules" required
                      hide-details="auto" variant="underlined" color="info" label="NIT" />
                  </v-col>
                </v-row>
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field v-model="txtregdata.email" :rules="emailRules" required hide-details="auto"
                      variant="underlined" color="info" label="Correo Electrónico" />
                  </v-col>
                </v-row>
                <br>
                <!-- Dirección -->
                <v-row>
                  <v-col cols="12" md="8">
                    <v-text-field v-model="txtregdata.direccion" :rules="nombreRules" required hide-details="auto"
                      variant="underlined" color="info" label="Dirección domicilio" />
                  </v-col>
                </v-row>
