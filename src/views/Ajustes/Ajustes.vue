                    ...
                    <v-row>
                        ...
                        <v-col cols="12" md="3">
                            <v-autocomplete v-model="filters.proveedor_id" :items="proveedoresList"
                                ...
                                color="primary" label="Proveedor" clearable required>
                        ...
                        <v-row>
                            <v-col cols="12" md="2">
                                <v-form @submit.prevent="searchCodigo()">
                                    <v-text-field ref="codigoBarrasInput" v-model="searchCodigoBarras"
                                        variant="outlined" color="primary" label="Código de barras" hide-details="auto"
                                        clearable />
                                </v-form>
                            </v-col>
                            <v-col cols="10" md="2">
                                <v-select :items="['Ajuste', 'Devolución']" v-model="datosCompra.status"
                                    label="Tipo de ajuste" variant="underlined" color="primary"></v-select>
                            </v-col>
                            <v-col cols="12" md="4">
                                ...
                                <tbody>
                                    <tr v-for="item in itemselected" :key="item.id">
                                        ...
                                        <td><small><v-text-field type="number" v-model="item.stock" variant="underlined"
                                                    min="1" color="primary" clearable></v-text-field></small></td>
                                        <td>
...
const searchCodigo = async () => {
    try {
        const codigo = searchCodigoBarras.value;
        ...
        searchCodigoBarras.value = ''
        searchCodigoBarras.value.focus();
    } catch (error) {
