<template>
    ...
    <v-chip label color="primary" text-color="primary">
        <v-btn @click="nuevaProveedor" icon="mdi mdi-plus" density="compact"></v-btn>Nuevo
    </v-chip>
    <br><br>
    <v-row>
        <SearchComponent v-model="search" label="Nombre, apellido, cédula..." :min-chars="3" @search="buscarProveedor" />
        <v-col cols="12" md="3">
            <v-btn color="primary" @click="getProveedores()">Todos</v-btn>
        </v-col>
    </v-row>
    <table>
        <thead>
