<template>
    ...
    <v-row>
        <v-col cols="12" md="3">
            <v-text-field v-model="search" append-inner-icon="mdi-magnify" label="nombre, apaellido, cedula..."
                variant="underlined" color="info" clearable />
        </v-col>
        <v-col cols="12" md="3">
            <v-btn color="info" @click="getclientes()">Todos</v-btn>
        </v-col>
    </v-row>
...
const deleteCliente = async (id) => {
    let confirmac = confirm('Eliminar esta cliente?');
    if (confirmac) {
